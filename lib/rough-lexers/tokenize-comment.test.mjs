    ...
    deep(lex,
        {
            ...
            notices: [],
            source: '/**/',
            tokens: [ { kind: 'COMMENT_BLOCK', chars: '/**/'.split(''), start: 0 } ],
        },
    ...
    deep(lex,
        {
            ...
            notices: [],
            source: 'abc/**/xyz',
            tokens: [ { kind: 'COMMENT_BLOCK', chars: '/**/'.split(''), start: 3 } ],
        },
    ...
    deep(lex,
        {
            ...
            notices: [],
            source: `start /* "not a string" 'x' */ end`,
            tokens: [ { kind: 'COMMENT_BLOCK', chars: `/* "not a string" 'x' */`.split(''), start: 6 } ],
        },
    ...
    deep(lex,
        {
            ...
            source: '/**//**//**/',
            tokens: [
                { kind: 'COMMENT_BLOCK', chars: '/**/'.split(''), start: 0 },
                { kind: 'COMMENT_BLOCK', chars: '/**/'.split(''), start: 4 },
                { kind: 'COMMENT_BLOCK', chars: '/**/'.split(''), start: 8 },
            ],
        },
    ...
    deep(lex,
        {
            ...
            tokens: [
                { kind: 'COMMENT_LINE', chars: '//\n'.split(''), start: 0 },
                { kind: 'COMMENT_BLOCK', chars: '/**/'.split(''), start: 3 },
                { kind: 'COMMENT_BLOCK', chars: '/**/'.split(''), start: 7 },
                { kind: 'COMMENT_LINE', chars: '//'.split(''), start: 11 },
            ],
        },
