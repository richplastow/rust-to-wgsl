...
const spc = { kind: 'WS', rust: [' '] }; // a single space character
...
export const testRoughlyParseRust = () => {
    ...
    deep(
        ...
        [
            { kind: 'NUM_DECIMAL_INTEGER', pos: 0, rust: ['0'] },
            { kind: 'IDENTIFIER', pos: 1, rust: ['i','3'] },
        ],
    ...
    deep(
        ...
        [   spc,
            ...
            { kind: 'IDENTIFIER', pos: 4, rust: ['u','1','2'] },
            sc,
        ],
    ...
    deep(
        fn('.0'),
        [{ kind: 'WS', rust: ['.'] },{ kind: 'NUM_DECIMAL_INTEGER', pos: 1, rust: ['0'] }],
    ...
    deep(
        ...
        [   sc,
            ...
            { kind: 'IDENTIFIER', pos: 4, rust: ['f','3','0'] },
            sc,
        ],
    ...
    deep(
        ...
        [
            ...
            { kind: 'IDENTIFIER', pos: 2, rust: ['b','2'] },
            sc,
        ],
    ...
    deep(
        ...
        [
            spc,
            { kind: 'NUM_DECIMAL_INTEGER', pos: 1, rust: ['0'] },
            { kind: 'IDENTIFIER', pos: 2, rust: 'b___'.split('') },
            sc,
        ],
    ...
    deep(
        ...
        [
            { kind: 'NUM_DECIMAL_INTEGER', pos: 0, rust: ['0'] },
            { kind: 'IDENTIFIER', pos: 1, rust: ['o','8'] },
        ],
        'Just "0o8"'
    );
    deep(
        ...
        [
            sc,
            { kind: 'NUM_DECIMAL_INTEGER', pos: 1, rust: ['0'] },
            { kind: 'IDENTIFIER', pos: 2, rust: 'o___'.split('') },
            spc,
        ],
    ...
    deep(
        ...
        [
            { kind: 'NUM_DECIMAL_INTEGER', pos: 0, rust: ['0'] },
            { kind: 'IDENTIFIER', pos: 1, rust: 'x___'.split('') },
        ],
        'Just "0x___"'
    );
    deep(
        ...
        [
            spc,
            { kind: 'NUM_DECIMAL_INTEGER', pos: 1, rust: ['0'] },
            { kind: 'IDENTIFIER', pos: 2, rust: ['x','G'] },
            sc,
        ],
