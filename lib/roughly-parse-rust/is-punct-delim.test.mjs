...
const punctuationFollowedChars = [
    { char: '-', name: 'Minus' },
    { char: ':', name: 'Colon' },
    { char: '!', name: 'Not' },
    { char: '.', name: 'Dot' },
...
const testIsPunctuationFollowed = () => {
    punctuationFollowedChars.forEach(({ char, name }) => {
        eq(
            isPunctuationFollowed(char),
            true,
    ...
    console.log('OK: All isPunctuationFollowed() tests passed!');
}
...
const testIsPunctuationSolo = () => {
    ...
    [...punctuationFollowedChars, ...delimiterChars, ...nonPunctuationChars]
        .forEach(({ char, name }) => {
        eq(
            isPunctuationSolo(char),
            false,
...
const testIsDelimiter = () => {
    ...
    [...punctuationFollowedChars, ...punctuationSoloChars, ...nonPunctuationChars]
        .forEach(({ char, name }) => {
        eq(
            isDelimiter(char),
            false,
